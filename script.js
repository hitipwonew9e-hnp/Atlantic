  ...
  let zminna1 = {
    data() {
        return {
          imgArr1: [
            { name: 'Atlantic Elegance.jpg', title: 'фото 1' },
...
let zminna2 = {
  data() {
      return {
        imgArr2: [
          { name: 'Atlantic Seagold.jpg', title: 'фото 1' },
...
let zminna3 = {
    data() {
        return {
          imgArr3: [
            { name: 'Atlantic SEALINE.jpg', title: 'фото 1' },
...
let zminna4 = {
    data() {
        return {
          imgArr4: [
{ name: 'Atlantic Seasport.jpg', title: 'фото 1' },
...
let zminna5 = {
      data() {
          return {
            imgArr5: [
                { name: 'Atlantic Seatrend.jpg', title: 'фото 1' },
...
let zminna6 = {
      data() {
          return {
            imgArr6: [
              { name: 'Atlantic Woldmaster Square.jpg', title: 'фото 1' },
        ...
        data() {
            return {
              imgArr7: [
                ...
                { name: 'Atlantic Worldmaster 1888 Lusso.jpg', title: 'фото 1' },
...
let zminna8 = {
    data() {
        return {
          imgArr8: [
            { name: 'Atlantic WORLDMASTER 1888.jpg', title: 'фото 1' },
...
let zminna9 = {
    data() {
        return {
          imgArr9: [
            { name: 'Atlantic WORLDMASTER DIVER.jpg', title: 'фото 1' },
...
let zminna10 = {
    data() {
        return {
          imgArr10: [
            { name: 'Atlantic Worldmaster Original.jpg', title: 'фото 1' },
